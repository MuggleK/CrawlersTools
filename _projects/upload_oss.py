...
class UploadOss(object):
    ...
    ```python
    >>> upload = UploadOss('(pdf|txt|doc|docx|xlsx|xls|csv|wps|hlp|rtf|ppt|pptx|zip|rar|jar|gz|jpg|jpeg|png|tif|gif|bmp)')
    ...
    def post_file(name, resp):
        ...
        res = requests.post("https://ips-gateway.qizhidao.com/framework/file/sign/webcreate", json=data)
        json_data = res.json()
